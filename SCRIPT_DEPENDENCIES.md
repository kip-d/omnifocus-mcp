...
- update-project.ts (helpers + repeat-helpers + bridge-template + multiple bridges)
...
- task-velocity.ts → Date filtering
[12+ scripts total]
...
- update-project.ts → repeat-helpers
[4 scripts, 2 helpers]
...
- All analytics scripts → Various bridges
[25+ scripts total]
...
- Time zone handling
Potential extraction: Shared date-filter helper function
...
- Status checking
- Count accumulation
Potential extraction: Shared aggregation helper
...
Potential extraction: safeGetTaskStatus() helper
