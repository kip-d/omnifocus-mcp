...
describe('OmniFocusReadTool Integration', () => {
  ...
  // Note: ID filtering is thoroughly tested in end-to-end.test.ts via MCP protocol
  // Direct tool execution (without MCP) doesn't reliably support task creation,
  // so we don't test the full create->query->cleanup cycle here.
});
