...
describe('Response Format Utilities', () => {
  ...
  describe('createSuccessResponseV2', () => {
    it('should create basic success response', () => {
      ...
      const response = createSuccessResponseV2('test-operation', data, undefined, timer.toMetadata());
    ...
    it('should handle complex data structures', () => {
      ...
      const response = createSuccessResponseV2('complex', complexData, undefined, timer.toMetadata());
    ...
    it('should include optional summary', () => {
      ...
      const response = createSuccessResponseV2('with-summary', { items: [] }, summary, timer.toMetadata());
    ...
    it('should handle null data', () => {
      ...
      const response = createSuccessResponseV2('null-data', null as any, undefined, timer.toMetadata());
  ...
  describe('createErrorResponseV2', () => {
    ...
    it('should include recovery suggestions', () => {
      const timer = new OperationTimerV2();
      const details = {
        recovery: ['Check your input', 'Try again later', 'Contact support'],
      };
  ...
  describe('createListResponseV2', () => {
    it('should create list response with items and preview', () => {
      ...
      const response = createListResponseV2('list-operation', items, 'other', timer.toMetadata());
  ...
  describe('createTaskResponseV2', () => {
    it('should create task response with tasks and summary', () => {
      ...
      const response = createTaskResponseV2('task-query', tasks, timer.toMetadata());
    ...
    it('should handle tasks with full details', () => {
      ...
      const response = createTaskResponseV2('detailed-tasks', detailedTasks, timer.toMetadata());
  ...
  describe('createAnalyticsResponseV2', () => {
    it('should create analytics response with metrics', () => {
      ...
      const keyFindings = ['Completion rate is 75%', 'Average 12.5 tasks per day'];
