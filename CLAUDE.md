...
## V2.0.0 Tool Architecture

### V1 Tools Removed
As of v2.0.0, all V1 legacy tools have been completely removed to:
- Reduce context window usage by ~30%
...
- **All other tools**: Use the optimized versions in `src/tools/`
