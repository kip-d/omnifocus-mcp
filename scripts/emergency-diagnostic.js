...
const tests = [
  {
    ...
    command:
      '{"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"name":"system","arguments":{"operation":"version"}}}',
  },
  {
    name: 'System Diagnostics',
    command:
      '{"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"name":"system","arguments":{"operation":"diagnostics"}}}',
  },
  {
    name: 'Basic Task Query (All, limit 5)',
    command:
      '{"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"name":"tasks","arguments":{"mode":"all","limit":5,"details":false}}}',
  },
  {
    name: "Today's Tasks",
    command:
      '{"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"name":"tasks","arguments":{"mode":"today","limit":5}}}',
  },
  {
    name: 'Project List (limit 5)',
    command:
      '{"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"name":"projects","arguments":{"operation":"list","limit":5}}}',
  },
  {
    name: 'Tag List (active)',
    command:
      '{"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"name":"tags","arguments":{"operation":"active"}}}',
  },
  {
    name: 'Productivity Stats (today)',
    command:
      '{"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"name":"productivity_stats","arguments":{"period":"today","includeProjectStats":false,"includeTagStats":false}}}',
  },
  {
    name: 'Create Test Task (without null fields)',
    command:
      '{"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"name":"manage_task","arguments":{"operation":"create","name":"Emergency Diagnostic Test","tags":["test"]}}}',
  },
];
            ...
            if (toolResponse.data) {
              if (Array.isArray(toolResponse.data)) {
                ...
                if (toolResponse.data.stats.overview) {
                  ...
                  console.log(
                    `   Total tasks: ${overview.totalTasks || 0}, Completed: ${overview.completedTasks || 0}`,
                  );
                }
