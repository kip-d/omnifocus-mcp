...
| `src/omnifocus/scripts/tasks/complete-task.ts`, `delete-task.ts`, `delete-tasks-bulk.ts`  | DELETE | legacy unguarded scripts (injection-hazard class)                                                                                                                                    |
| `src/omnifocus/scripts/tasks.ts`                                                          | modify | drop the three re-exports                                                                                                                                                            |
...
| `tests/unit/contracts/ast/mutation-script-builder.test.ts`                                | modify | wrapper tests updated; `buildBatchScript`/`buildBulkDeleteScript` describe blocks DELETED                                                                                            |
| `tests/integration/tools/unified/complete-delete-paths.test.ts`                           | create | OMN-138 live coverage (sandbox-scoped)                                                                                                                                               |
| `docs/superpowers/specs/2026-06-10-update-task-project-mutation-ast-design.md`            | modify | riding doc minor (§1: stale "slice 5+" tag-builder sentence)                                                                                                                         |
