...
| Layer             | Cases                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Unit — vocabulary | Closed-vocabulary assertion scanning ALL THREE emitting modules (script-result-types / OmniAutomation / base.ts); each dialect → its canonical context; `{success:false}` context preservation in details; the `NULL_RESULT` `error` value survives the context rename (consumer + IGNORE_SET still match); `'Legacy script error'` / `'OmniAutomation execution error'` no longer emitted anywhere. (§5 is authoritative where it and this row differ.) |
