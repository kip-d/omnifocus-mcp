...
- **[docs/dev/FILTER_PIPELINE.md](dev/FILTER_PIPELINE.md)** - End-to-end filter pipeline (4-layer checklist for adding
  new filters)
- **[docs/dev/SESSION_RESUME_2026-02-10.md](dev/SESSION_RESUME_2026-02-10.md)** - Developer handoff: week of Feb 3-10
  structural changes, architecture overview, known issues
