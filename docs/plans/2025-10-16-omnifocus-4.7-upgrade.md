...
|---------|--------|-------|
| **Planned Dates** | ✅ Implemented | Full support in ManageTaskTool, queries, unified API |
| **Date Schemas Module** | ✅ Implemented | `src/tools/schemas/date-schemas.ts` |
| **Version Detection** | ✅ Implemented | Lazy detection with graceful degradation |
| **Mutually Exclusive Tags** | ❌ Not Started | Read/toggle functionality on tag groups |
| **Enhanced Repeats (Intent Keywords)** | ❌ Not Started | "when-marked-done" etc. translation layer |
