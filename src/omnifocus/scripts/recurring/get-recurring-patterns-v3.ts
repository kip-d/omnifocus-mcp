/**
 * Script to analyze and summarize recurring task patterns in OmniFocus - V3 Pure OmniJS
 *
 * V3 Changes:
 * - Removed getUnifiedHelpers() dependency
 * - Removed formatError() - inline error handling
 * - V3 response format
 * - Already used OmniJS bridge (kept as-is)
 *
 * Features:
    ...
    try {
      ...
      return JSON.stringify({
        ...
        error: {
          ...
          stack: error.stack,
          operation: 'get_recurring_patterns'
        }
      });
    }
  })();
